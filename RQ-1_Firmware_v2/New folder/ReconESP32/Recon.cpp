...
Recon::Recon() {
  board_pins[FRONT_RIGHT_HIP]  = 13;
  board_pins[FRONT_LEFT_HIP]   = 14;
  board_pins[BACK_RIGHT_HIP]   = 15;
  board_pins[BACK_LEFT_HIP]    = 18;
  
  board_pins[FRONT_RIGHT_LEG]  = 19;
  board_pins[FRONT_LEFT_LEG]   = 23;
  board_pins[BACK_RIGHT_LEG]   = 25;
  board_pins[BACK_LEFT_LEG]    = 26;
}
